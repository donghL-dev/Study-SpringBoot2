...
import static com.donghun.domain.enums.SocialType.FACEBOOK;
import static com.donghun.domain.enums.SocialType.GOOGLE;
import static com.donghun.domain.enums.SocialType.KAKAO;
...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private User getModernUser(SocialType socialType, Map<String, Object> map) {
        return User.builder()
                ...
                .prinicpal(String.valueOf(map.get("id")))
    ...
    private void setRoleIfNotSame(User user, OAuth2AuthenticationToken authentication, Map<String, Object> map) {
        if(!authentication.getAuthorities().contains(new SimpleGrantedAuthority(user.getSocialType().getRoleType()))) {
            SecurityContextHolder.getContext().setAuthentication(new
                    UsernamePasswordAuthenticationToken(map, "N/A", AuthorityUtils.createAuthorityList(user.getSocialType().getRoleType())));
        }
    }
